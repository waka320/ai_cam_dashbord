        ...
        <Paper elevation={1} sx={{ 
          ...
          <Box sx={{ mt: 3 }}>
            <Typography variant="body1" sx={{ mb: 2 }}>
              本規約は、名古屋大学 遠藤・浦田研究室（以下、「当研究室」といいます）が提供する「目的ベースダッシュボード」（以下、「本サービス」といいます）について、利用者による利用の一切について適用されるものです。本サービスは、当研究室に所属する学生（若松勇希）が管理し、高山市が公開するオープンデータ「まちなかにおける観光通行量調査データ」を活用したデータ表示・分析サービスです。本サービスの利用にあたっては本規約への同意を条件としますので、利用前に必ず本規約を確認のうえ、理解いただくようお願いします。
            </Typography>
          ...
          <Box id="terms-section" sx={{ mb: 4 }}>
            ...
            >
              ...
              <AccordionDetails sx={{ bgcolor: 'white', color: 'text.primary' }}>
                ...
                <Typography variant="body1">
                  本サービスで使用しているデータは、高山市オープンデータ利用規約（
                  <Link href="https://www.city.takayama.lg.jp/shisei/1005252/1010628.html" target="_blank" rel="noopener noreferrer">
                    https://www.city.takayama.lg.jp/shisei/1005252/1010628.html
                  </Link>
                  ）に準拠しており、クリエイティブ・コモンズ表示4.0国際ライセンスが適用されています。
                </Typography>
              </AccordionDetails>
            </Accordion>
